...
{
    /// <summary>
    /// Provides the application services for managing and navigating the thesaurus.
    /// </summary>
    /// <remarks>
    /// Centralizes concept access, persistence, graph navigation, reference management and term normalization.
    ///
    /// The service resolves concepts from file formats and preferred terms, exposes ancestor and descendant relations,
    /// and provides the semantic paths used by the analysis engines to select contributions from thesaurus tags.
    ///
    /// It also enforces graph consistency when creating parent/child links and builds the multi-parent concept tree
    /// used for thesaurus navigation.
    /// </remarks>
